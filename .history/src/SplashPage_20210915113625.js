  ...
  return (
    <div>
      <Container>
        ...
        <Row>
          <Col md={{span: 4, offset: 8}}>
          <section className="mw=5rem"><p class="text-left text-end" >Trade stocks from the safety of your very own fake bank account.
        ...
        <Row>
          <Col md={{offset: 9}}>
          <Button variant="secondary" class="text-end">Sign Up</Button>
          <span> </span>
          <Button variant="secondary" class="text-end">Login</Button>
          </Col>
