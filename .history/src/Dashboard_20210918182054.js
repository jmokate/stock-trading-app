    ...
    <Container className="user-info">
      <Row>
        ...
        <Form.Group>
          ...
          <Form.Control type="text" placeholder="ex. AAPL" name="ticker" value={userInput.ticker}></Form.Control>
          <Form.Label>
            Shares Amount:
          </Form.Label>
          <Form.Control type="number" placeholder="ex. 1" name="amount" value={userInput.amount}></Form.Control>
        </Form.Group>
      </Row>
      <Row>
